...
class BotoesStart:
    ...
    def finalizar(self,outraJanela):
        if outraJanela is not None: # Harmonizar chama esse método apenas para resgatar valor na variável tom
            outraJanela.destroy()
        return tom
